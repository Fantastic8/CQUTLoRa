...
class LoRaPackage:
    ...
    __COMMAND_FETCH='FETCH'
    __COMMAND_INSERT='INSERT'
    __COMMAND_TDATA='TDATA'
    __COMMAND_STANDBY='STANDBY'
    __COMMAND_AWAKE='AWAKE'
    __COMMAND_RESET='RESET'
    __COMMAND_ACKNOWLEDGE='ACKNOWLEDGE'
    __COMMAND_RTABLE='RTABLE'
    ...
    def setFETCH(self,tname,*params):
        ...
        '''
        self.__COMMAND_TYPE=self.__COMMAND_FETCH
    ...
    def setINSERT(self,tname,*params):
        ...
        set __COMMAND_CONT to match right form of parameters
        '''
        self.__COMMAND_TYPE=self.__COMMAND_INSERT
        self.__COMMAND_CONT='<TNAME>'+tname+'</TNAME>'
        for param in params:
            self.__COMMAND_CONT+='<PARAM>'+param+'</PARAM>'
    ...
    def setTDATA(self,message):
        ...
        '''
        self.__COMMAND_TYPE=self.__COMMAND_TDATA
    ...
    def setSTANDBY(self):
        ...
        '''
        self.__COMMAND_TYPE=self.__COMMAND_STANDBY
        self.__COMMAND_CONT=''
        self.__COMMAND_ID=-1
    ...
    def setAWAKE(self):
        ...
        clear __COMMAND_CONT and __COMMAND_ID
        '''
        self.__COMMAND_TYPE=self.__COMMAND_AWAKE
        self.__COMMAND_CONT=''
        self.__COMMAND_ID=-1
    ...
    def setRESET(self):
        ...
        clear __COMMAND_CONT and __COMMAND_ID
        '''
        self.__COMMAND_TYPE=self.__COMMAND_RESET
        self.__COMMAND_CONT=''
        self.__COMMAND_ID=-1
    ...
    Input:
        command_id: the command id user wants to reply to
        message: the message that user wants to reply
    Output:
        void
    '''
    def setACKNOWLEDGE(self,command_id,message):
        '''
        ...
        self.__COMMAND_TYPE=self.__COMMAND_ACKNOWLEDGE
        self.__COMMAND_CONT=message
    ...
    def setRTABLE(self,**table):
        ...
        ***
        '''
        self.__COMMAND_TYPE=self.__COMMAND_RTABLE
    ...
    def wrap(self,encoding='utf-8'):
        ...
        # COMMAND part
        if self.__COMMAND_TYPE==self.__COMMAND_STANDBY or self.__COMMAND_TYPE==self.__COMMAND_AWAKE or self.__COMMAND_TYPE==self.__COMMAND_RESET:
            package+='<'+self.__COMMAND_TYPE+'>'
        elif self.__COMMAND_TYPE==self.__COMMAND_FETCH or self.__COMMAND_TYPE==self.__COMMAND_INSERT or self.__COMMAND_TYPE==self.__COMMAND_TDATA or self.__COMMAND_TYPE==self.__COMMAND_ACKNOWLEDGE or self.__COMMAND_TYPE==self.__COMMAND_RTABLE:
    ...
    def unwrap(self,package:String):
        ...
        if not (command_type==self.__COMMAND_ACKNOWLEDGE or command_type==self.__COMMAND_AWAKE or command_type==self.__COMMAND_FETCH or command_type==self.__COMMAND_INSERT or command_type==self.__COMMAND_RESET or command_type==self.__COMMAND_RTABLE or command_type==self.__COMMAND_STANDBY or command_type==self.__COMMAND_TDATA):
            return False
    ...
    '''
    def getFETCH(self):
        if self.__COMMAND_TYPE!=self.__COMMAND_FETCH:
            return None
    ...
    '''
    def getINSERT(self):
        if self.__COMMAND_TYPE!=self.__COMMAND_INSERT:
            return None
        return self.__getParameters(self.__COMMAND_CONT)
    ...
    '''
    def getTDATA(self):
        if self.__COMMAND_TYPE!=self.__COMMAND_TDATA:
            return None
        return self.__COMMAND_CONT
    ...
    def getACKNOWLEDGE(self):
        if self.__COMMAND_TYPE!=self.__COMMAND_ACKNOWLEDGE:
            return None
        return self.__COMMAND_CONT
    ...
    '''
    def isSTANDBY(self):
        return self.__COMMAND_TYPE==self.__COMMAND_STANDBY
    ...
    '''
    def isAWAKE(self):
        return self.__COMMAND_TYPE==self.__COMMAND_AWAKE
    ...
    '''
    def isRESET(self):
        return self.__COMMAND_TYPE==self.__COMMAND_RESET    
